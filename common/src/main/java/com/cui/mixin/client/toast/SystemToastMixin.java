...
#if MC_VER >= V1_21_3 import net.minecraft.client.gui.components.toasts.SystemToast;
...
@Mixin(#if MC_VER >= V1_21_6 SystemToast.class #else Minecraft.class #endif)
public class SystemToastMixin {
    #if MC_VER >= V1_21_6
    @Redirect(at = @At(value = "INVOKE", target = GuiGraphicsMethods.blitSprite1Rec), method = "render")
