...
public class HUDMixin {
	...
	#if MC_VER >= V1_21 private void renderHead(GuiGraphics guiGraphics, int x, CallbackInfo ci) #else private void renderExperienceBarHead(GuiGraphics guiGraphics, int x, CallbackInfo ci)#endif {
	...
	#if MC_VER >= V1_21 private void renderHead(GuiGraphics guiGraphics, int x, CallbackInfo ci) #else private void renderExperienceBarTail(GuiGraphics guiGraphics, int x, CallbackInfo ci)#endif {
     ...
     * */
    @Redirect(at = @At(value = "INVOKE", target = #if MC_VER >= V1_20_4 "Lnet/minecraft/client/gui/GuiGraphics;blitSprite(" #if MC_VER >= V1_21_6 + "Lcom/mojang/blaze3d/pipeline/RenderPipeline;" #elif MC_VER >= V1_21_3 + "Ljava/util/function/Function;" #endif + "Lnet/minecraft/resources/ResourceLocation;IIII)V" #else "Lnet/minecraft/client/gui/GuiGraphics;blit(Lnet/minecraft/resources/ResourceLocation;IIIIII)V" #endif, ordinal = #if MC_VER >= V1_21_3 0 #else 6 #endif), method = #if MC_VER >= V1_21_3 "renderAirBubbles" #else "renderPlayerHealth" #endif)
    ...
    @Redirect(at = @At(value = "INVOKE", target = #if MC_VER >= V1_20_4 "Lnet/minecraft/client/gui/GuiGraphics;blitSprite(" #if MC_VER >= V1_21_6 + "Lcom/mojang/blaze3d/pipeline/RenderPipeline;" #elif MC_VER >= V1_21_3 + "Ljava/util/function/Function;" #endif + "Lnet/minecraft/resources/ResourceLocation;IIII)V" #else "Lnet/minecraft/client/gui/GuiGraphics;blit(Lnet/minecraft/resources/ResourceLocation;IIIIII)V" #endif, ordinal = #if MC_VER >= V1_21_3 1 #else 7 #endif), method = #if MC_VER >= V1_21_3 "renderAirBubbles" #else "renderPlayerHealth" #endif)
     ...
     * <h5> Food coloring <h5/>
     * */
    @Redirect(at = @At(value = "INVOKE", target = #if MC_VER >= V1_20_4 "Lnet/minecraft/client/gui/GuiGraphics;blitSprite(" #if MC_VER >= V1_21_6 + "Lcom/mojang/blaze3d/pipeline/RenderPipeline;" #elif MC_VER >= V1_21_3 + "Ljava/util/function/Function;" #endif + "Lnet/minecraft/resources/ResourceLocation;IIII)V" #else "Lnet/minecraft/client/gui/GuiGraphics;blit(Lnet/minecraft/resources/ResourceLocation;IIIIII)V" #endif, ordinal = #if MC_VER >= V1_21_3 0 #else 3 #endif), method = #if MC_VER >= V1_21 "renderFood" #else "renderPlayerHealth" #endif)
    private void injected12(
            GuiGraphics instance,
            #if MC_VER >= V1_21_6 RenderPipeline pipeline, #elif MC_VER >= V1_21_3 Function<ResourceLocation, RenderType> pipeline, #endif
            ResourceLocation sprite,
            #if MC_VER >= V1_20_4
    ...
    @Redirect(at = @At(value = "INVOKE", target = #if MC_VER >= V1_20_4 "Lnet/minecraft/client/gui/GuiGraphics;blitSprite(" #if MC_VER >= V1_21_6 + "Lcom/mojang/blaze3d/pipeline/RenderPipeline;" #elif MC_VER >= V1_21_3 + "Ljava/util/function/Function;" #endif + "Lnet/minecraft/resources/ResourceLocation;IIII)V" #else "Lnet/minecraft/client/gui/GuiGraphics;blit(Lnet/minecraft/resources/ResourceLocation;IIIIII)V" #endif, ordinal = #if MC_VER >= V1_21_3 1 #else 4 #endif), method = #if MC_VER >= V1_21 "renderFood" #else "renderPlayerHealth" #endif)
    private void injected13(
            GuiGraphics instance,
            #if MC_VER >= V1_21_6 RenderPipeline pipeline, #elif MC_VER >= V1_21_3 Function<ResourceLocation, RenderType> pipeline, #endif
            ResourceLocation sprite,
            #if MC_VER >= V1_20_4
    ...
    @Redirect(at = @At(value = "INVOKE", target = #if MC_VER >= V1_20_4 "Lnet/minecraft/client/gui/GuiGraphics;blitSprite(" #if MC_VER >= V1_21_6 + "Lcom/mojang/blaze3d/pipeline/RenderPipeline;" #elif MC_VER >= V1_21_3 + "Ljava/util/function/Function;" #endif + "Lnet/minecraft/resources/ResourceLocation;IIII)V" #else "Lnet/minecraft/client/gui/GuiGraphics;blit(Lnet/minecraft/resources/ResourceLocation;IIIIII)V" #endif, ordinal = #if MC_VER >= V1_21_3 2 #else 5 #endif), method = #if MC_VER >= V1_21 "renderFood" #else "renderPlayerHealth" #endif)
    private void injected14(
            GuiGraphics instance,
            #if MC_VER >= V1_21_6 RenderPipeline pipeline, #elif MC_VER >= V1_21_3 Function<ResourceLocation, RenderType> pipeline, #endif
            ResourceLocation sprite,
            #if MC_VER >= V1_20_4
